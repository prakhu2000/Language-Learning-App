...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("mother", "मां", R.drawable.family_mother, R.raw.family_mother));
        ...
        words.add(new Word("elder brother", "बड़े भाई", R.drawable.family_older_brother,
                R.raw.family_older_brother));
        words.add(new Word("younger brother", "छोटा भाई", R.drawable.family_younger_brother,
                R.raw.family_younger_brother));
        words.add(new Word("elder sister", "बड़ी बहन", R.drawable.family_older_sister,
